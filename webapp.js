...
function changeDisplay(choice) {
	...
	switch(choice) {
		case "intro":
			...
			btn1.setAttribute("onClick", "changeDisplay('pet')");   // <button onClick="changeDisplay('pet');"></button>
			btn1.innerHTML = "Try to pet it";									// <button onClick="changeDisplay('pet');">try to pet it</button>
		...
		case "dodge":
			...
			btn1.innerHTML = "Try to dodge the rocks";
